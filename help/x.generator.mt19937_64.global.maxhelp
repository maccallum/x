...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.0, 267.0, 93.0, 20.0 ],
					"style" : "",
					"text" : "prepend setmin"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 201.0, 75.0, 421.0, 42.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 65.0, 237.0, 87.0, 20.0 ],
					"style" : "",
					"text" : "route max min"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 313.0, 297.0, 37.0, 20.0 ],
					"style" : "",
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 201.0, 26.0, 430.0, 42.0 ],
					"style" : "",
					"text" : "Produce a pseudo-random value using the MT19937 64-bit generator. The global suffix means that only one instance of x.generator.mt19937_64 will be used even if many instances of x.generator.mt19937_64.global are used."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 334.0, 146.0, 108.0 ],
					"setminmax" : [ -1.0, 0.0 ],
					"setstyle" : 4,
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 270.0, 297.0, 41.0, 20.0 ],
					"style" : "",
					"text" : "mean"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 270.0, 267.0, 94.0, 20.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 65.0, 109.0, 113.0, 20.0 ],
					"style" : "",
					"text" : "max, min, generate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 65.0, 140.0, 176.0, 20.0 ],
					"style" : "",
					"text" : "x.generator.mt19937_64.global"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "x.generator.mt19937_64.global.maxpat",
